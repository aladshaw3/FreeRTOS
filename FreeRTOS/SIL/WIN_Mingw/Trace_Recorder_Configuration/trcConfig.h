...
// NOTE: Due to how Simulink autogenerates functions for linkages, this option
//      MUST BE DISABLED! Otherwise, Simulink autogenerates functions that have
//      no real linkages and causes build errors. 
